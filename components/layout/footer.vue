<template>
  ...
  <div class="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <span class="block w-32 h-10 bg-gray-900 rounded-lg"></span>


        <div class="flex mt-8 text-gray-500 space-x-6">

          <a class="hover:opacity-75" href="https://www.instagram.com/wimaxclub/" target="_blank" rel="noreferrer">
          ...
          <a class="hover:opacity-75" href="https://github.com/AI-DS-Community" target="_blank" rel="noreferrer">
