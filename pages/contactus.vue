<template>
    <section id="contact" class="flex justify-center items-center h-screen bg-gray-900 px-6 py-3">
        <form ref="contact" novalidate="" class="container-fluid w-full max-w-xl p-8 mx-auto space-y-6 rounded-md shadow dark:bg-gray-900 ng-untouched ng-pristine ng-valid" @submit="contactus">
            <h2 class="w-full text-5xl font-bold leading-tight text-blue-300">Contact us</h2>
            <div class="px-4">
                <label for="name" class="block mb-1 ml-1 text-orange-500">Name</label>
                <input name = "name" id="name" type="text" placeholder="Your name" required="" class="block w-full p-2 rounded text-blue-300 focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-orange-400 dark:bg-gray-800">
            </div>
            <div class="px-4">
                <label for="email" class="block mb-1 ml-1 text-orange-500">Email</label>
                <input name="email_id" id="email" type="email" placeholder="Your email" required="" class="block w-full p-2 rounded text-blue-300 focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-orange-400 dark:bg-gray-800">
            </div>
            <div class="px-4">
                <label for="message" class="block mb-1 ml-1 text-orange-500">Message</label>
                <textarea name = "user_comment" id="message" type="text" placeholder="Message..." class="block w-full p-2 rounded autoexpand text-blue-300 focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-orange-400 dark:bg-gray-800"></textarea>
            </div>
            <div class="px-4">
